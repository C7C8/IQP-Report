...
\renewcommand\familydefault{\sfdefault}                     % Switch to sans-serif font
...
\fancyhead[L]{\truncate{.4\headwidth}{\rightmark}}
\fancyhead[C]{\raisebox{-5pt}{\centering\includegraphics[width=12pt]{images/city.png}}}
\fancyhead[R]{\raisebox{-2pt}{\footnotesize\textit{Eilat: Transportation 2040}}}
\fancyfoot[R]{\thepage}
\renewcommand{\headrulewidth}{1.5pt}
\renewcommand{\footrulewidth}{0.5pt}
\setlength{\headheight}{15.5pt} % Why can't I use setlength on head/footrulewidth? Beats me...
...
\begin{table}[H]
    ...
    \singlespacing
    \small
    \begin{tabular}{ m{0.12\columnwidth} | m{0.07\columnwidth} | m{0.11\columnwidth} | m{0.16\columnwidth} | m{0.19\columnwidth} | m{0.19\columnwidth} }
...
% explain what superblocks might be in Eilat a little
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\columnwidth]{images/site_map_schematic.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\columnwidth]{images/site_map_traffic.png}
...
%Maybe include info on optimal bus routes? maybe put that in background and extrapolate here
...
%need data on bus arrivals. Bureau of Statistics? Ministry of Transportation? Can't just be number of bus passengers, needs to be actual tourists

%If this data is not available, we'll have to estimate. yuck.
...
%Discuss parking lot plans viability
