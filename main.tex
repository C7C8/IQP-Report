...
%add info about actual usage (7.3% of ppl use buses, 12.2% use tour buses)
% add info on existing routes
%Why it is inefficient?
%comparison to other bus systems (within Israel or other cities of smiliar size scale)
